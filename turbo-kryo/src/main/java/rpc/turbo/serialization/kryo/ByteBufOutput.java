...
public class ByteBufOutput extends Output {
     ...
     *
     * @param maxBufferSize The buffer is doubled as needed until it exceeds maxCapacity and
     ...
     *
     * @param optimizePositive If true, small positive numbers will be more efficient (1 byte)
